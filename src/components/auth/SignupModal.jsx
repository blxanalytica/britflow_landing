            ...
            >
              ...
              <div className="relative bg-[#131826]/95 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-white/60">Start using BritFlow today</p>
                </div>
                ...
                <div className="relative mb-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-[#131826] text-white/50 font-medium">Or sign up with email</span>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <label className="flex items-start gap-3 text-white/70 cursor-pointer group pt-2">
                    <input
                      type="checkbox"
                      checked={formData.agreeToTerms}
                      onChange={(e) => setFormData({ ...formData, agreeToTerms: e.target.checked })}
                      className="w-4 h-4 mt-0.5 rounded border-white/20 bg-white/5 text-[#356AE6] focus:ring-2 focus:ring-[#356AE6]/30 focus:ring-offset-0"
                      required
                    />
                    <span className="text-sm leading-relaxed group-hover:text-white/90 transition-colors">
                      I agree to the{" "}
