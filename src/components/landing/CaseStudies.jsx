...
export default function CaseStudies() {
  const testimonials = [
    {
      quote: "Britflow cut our automation development time from weeks to days. The ability to switch between code and UI is a game-changer.",
      author: "Sarah Chen",
    ...
    {
      quote: "We automated our entire customer onboarding flow in under an hour. The AI integration possibilities are endless.",
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-lg text-white/70 leading-relaxed">
            See how teams are building the future with Britflow.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="relative rounded-3xl border border-white/10 bg-[#131826]/50 backdrop-blur-xl p-8 hover:border-white/20 transition-colors">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold bg-gradient-to-r from-[#7CF59F] to-[#356AE6] bg-clip-text text-transparent">
                      {testimonial.metric}
                    </div>
                  </div>
                </div>
